...
<br> **2026.09.08 [SEC] Atualizações SAP**
<br> A empresa incentiva os clientes a aplicarem as atualizações disponíveis de acordo com a prioridade. O boletim público da empresa não identifica nenhuma das vulnerabilidades de setembro como sendo ativamente exploradas, mas a combinação de caminhos de ataque não autenticados, exposição de credenciais e componentes de infraestrutura afetados torna importante a rápida correção.
<br> Publicado [aqui](https://www.linkedin.com/comm/pulse/sap-september-2026-security-update-includes-fixes-gteee)
...
<br> **2026.05.05 [SEC] Linux Copy Fail**
<br> Diferente de muitas vulnerabilidades do kernel, essa falha lógica é determinística, ou seja, não depende de condições de corrida ou deslocamentos específicos do kernel. Um único script Python de 732 bytes pode explorá-la com sucesso, sem qualquer modificação, em diferentes distribuições Linux.
<br> Publicado [aqui](https://unit42.paloaltonetworks.com/cve-2026-31431-copy-fail/) e [aqui](https://copy.fail)
...
<br> **2026.04.25 [SEC] Notícias de 17 a 23 de abril**
<br> Principais destaques em cibersegurança.
<br> Publicado [aqui](https://pt.linkedin.com/comm/pulse/principais-not%C3%ADcias-de-ciberseguran%C3%A7a-da-semana-17-23-abril-rfvcf)

<br> **2026.04.25 [SEC] Vulnerabilidade no Linux**
<br> A falha está na confiança com o PackageKit, que lida com GUI, linha de comandos e gerenciadores de pacotes entre diferentes distribuições. Como geralmente é executado com privilégios elevados, qualquer falha em sua lógica pode ter consequências de longo alcance. Os problemas foram identificados em condições específicas com Fedora e já foram corrigidos no PackageKit 1.3.5.
<br> Publicado [aqui](https://www.linkedin.com/comm/pulse/critical-vulnerability-exposes-linux-systems-root-level-dyz9e)
...
<br> **2026.04.22 [SEC] Claude Mythos encontra 271 falhas no Firefox**
<br> A ferramenta da Anthropic encontrou novas falhas até então desconhecidas no Firefox 150, o que gerou uma atualização com proporções até então inexistentes. O fato histórico traz novas reflexões relacionadas à segurança de aplicativos. 
<br> Publicado [aqui](https://www.linkedin.com/comm/pulse/claude-mythos-finds-amazing-271-flaws-firefox-9cqte)
...
<br> **2026.04.09 [SEC] Adobe Reader**
<br> Falha de segurança de dia zero., onde arquivos PDF maliciosos podem ser usados ​​para roubar dados confidenciais e potencialmente comprometer sistemas inteiros, sem exigir qualquer ação do usuário além de abrir o documento.
<br> Publicado [aqui](https://www.linkedin.com/comm/pulse/warning-critical-adobe-reader-zero-day-vulnerability-76g6e)
...
<br> **2025.11.05 [SEC] Vulnerabilidades no ChatGPT**
<br> A Tenable Research publicou um conjunto alarmante de descobertas em seu relatório “HackedGPT: Novas vulnerabilidades em IA abrem as portas para vazamento de dados privados”, revelando sete vulnerabilidades fundamentalmente graves na plataforma ChatGPT da OpenAI, que afetam tanto o GPT-4o quanto o recém-lançado GPT-5 e permitem que invasores extraiam dados privados de usuários.
<br> Publicado [aqui](https://www.linkedin.com/comm/pulse/tenable-uncovers-critical-chatgpt-vulnerabilities-nif3e)
...
<br> **2025.10.24 [SEC] Microsoft WSUS Vulnerability**
<br> A Microsoft disponibilizou uma atualização de segurança urgente para corrigir uma grave vulnerabilidade de execução remota de código (RCE) em sua plataforma Windows Server Update Services (WSUS). Como o WSUS normalmente é executado com privilégios de nível SYSTEM quando habilitado, a exploração bem-sucedida dessa falha concederia ao invasor controle total do sistema. Esta falha afeta todas as versões do Windows Server. 
<br> Publicado [aqui](https://www.linkedin.com/pulse/warning-threat-actors-exploit-newly-patched-microsoft-4iwke)
...
<br> **2025.07.20 [SEC] Resumo semanal sobre segurança cibernética**
<br> Disponível [aqui](https://www.linkedin.com/comm/pulse/weekly-cybersecurity-newsletter-chrome-0-day-vmware-umbic)
...
<br> **2025.07.07 [SEC] Gemini com acesso total no Android**
<br> Google informou que o Gemini acessará aplicativos de terceiros, mesmo com configuração desativada: a mudança entrou em vigor nesta segunda-feira e será aplicada automaticamente. Mesmo que o usuário tenha desabilitado a opção "atividade nos apps do Gemini", disponível nas configurações do próprio assistente, os dados serão armazenados por até 72 horas, e poderão ser lidos, anotados e analisados por revisores humanos, incluindo prestadores de serviços.
<br> Publicado [aqui](https://arstechnica.com/security/2025/07/unless-users-take-action-android-will-let-gemini-access-third-party-apps/)
...
<br> **2025.07.01 [AI] Revisão automatizada**
<br> Foi descoberto que pesquisadores inseriram comandos ocultos em artigos científicos para que IAs os avaliem positivamente: a análise envolveu pré-publicações em inglês na plataforma arXiv, e encontrou 17 artigos manipulados, voltados à área de ciência da computação e vinculados a instituições como a Universidade Columbia e a de Washington. As instruções foram disfarçadas com fontes brancas ou tamanhos de letra extremamente reduzidos. Alguns pesquisadores defendem a prática como uma forma de reagir ao uso indiscriminado de IA por revisores.
<br> Publicado [aqui](https://asia.nikkei.com/Business/Technology/Artificial-intelligence/Positive-review-only-Researchers-hide-AI-prompts-in-papers) e [aqui](https://techastro.com.br/revolucao-na-revisao-como-pesquisadores-usam-ia-oculta-para-influenciar-avaliacoes/)
...
<br> **2025.04.27 [SEC] Resumo semanal de 21 a 27.Abr**
<br> Boletim informativo sobre segurança cibernética, fornecendo as últimas atualizações e insights essenciais.
<br> Disponível [aqui](https://www.linkedin.com/comm/pulse/weekly-cyber-security-news-letter-last-weeks-top-p43vc)
...
<br> **2025.04.14 [SEC] Resumo semanal de 10 a 16.Mar**
<br> Boletim informativo sobre segurança cibernética, fornecendo as últimas atualizações e insights essenciais.
<br> Disponível [aqui](https://www.linkedin.com/comm/pulse/cybersecurity-weekly-recap-key-updates-attacks-vulnerabilities-mqzvc)
...
<br> **2025.02.10 [SEC] Apple disponibiliza atualizações de segurança para falhas do dia zero**
<br> Publicado [aqui](https://www.linkedin.com/comm/pulse/apple-releases-emergency-security-updates-zero-day-naghe)
...
<br> **2025.01.11 [SEC] Disponível Wireshark v4.4.3**
<br> Ferramenta para aprendizado e avaliação de segurança cibernética capaz de rastrear conexões, visualizar o conteúdo de transações de rede suspeitas e identificar picos de tráfego de rede dentre outras funcionalidades.
<br> Publicado [aqui](https://www.linkedin.com/comm/pulse/wireshark-version-443-ready-download-the-cyber-security-hub-0lbve)
...
<br> **2025.01.09 Raspberry Pi 5 com 16GB RAM**
...
<br> As "Vagas fantasmas" envolvem o anúncio de posições inexistentes, publicadas, em sua maioria, no LinkedIn e em sites corporativos. Entrevista com gestores de contratação norte-americanos admitem que essa estratégia visa avaliar a substituibilidade dos funcionários, enquanto outros afirmam que isso torna a companhia mais atrativa.
...
<br> Agências Federais dos EUA (CISA e FBI) sugerem tais programas abandonem o uso das linguagens C e C++ até 2026 em função de riscos a violação de memória e que representam um risco à segurança nacional, econômica e à saúde pública.
...
<br> Com o encerramento da divisão que promovia web livre e aberta, 40 funcionários foram desligados. Dentre as declarações, “colocar as pessoas antes do lucro parece cada vez mais radical”. Esta é a segunda rodada de cortes na Mozilla em 2024; em fevereiro, dezenas de funcionários do Firefox foram dispensados.
...
<br> Falha de segurança afeta todas as GPUs Nvidia GeForce e outras linhas. A solução é atualizar os driver em qualquer sistema. Para Windows, driver 566.03 e para Linux as versões 565.57.01, 550.127.05 e 535.216.01. Para as linhas RTX, Quadro e NVS, recomenda-se a instalação das releases 566.03, 553.24 e 538.95.
...
<br> Neste ano a Comissão Federal de Comunicações dos EUA prevê futuro onde internet via satélite e redes terrestres estejam integradas. O objetivo é garantir a conectividade em qualquer lugar, permitindo uma "conexão de backup no céu" quando sistemas em solo falharem ou estiverem indisponíveis durante desastres.
<br> Publicado [aqui](https://techneconomyblog.com/2024/03/22/a-single-network-future/) 

<br> **2024.11.04 [SEC:HIGH] Hackers Use ZIP File Concatenation Tactic**
<br> Cibercriminosos estão utilizando uma estratégia de evasão sofisticada chamada concatenação de arquivos ZIP para atingir especificamente usuários do Windows. Esse método combina vários arquivos ZIP em um único arquivo, dificultando a detecção de conteúdo malicioso por softwares de segurança. Como resultado, usuários desavisados ​​podem baixar inadvertidamente arquivos prejudiciais (malware), e os executando pois não houve detecção alguma relatada pelo programa anti-vírus.
<br> Publicado [aqui](https://cybersecuritynews.com/hackers-employ-zip-file-concatenation/)

<br> **2024.11.04 [SEC:HIGH] MediaTek Smartphone Chipsets Vulnerabilities**
<br> Diversas falhas foram encontradas, dentre elas se destacam CVE-2024-20104 (afetando os chipsets MT6781, MT6789, MT6835 entre outros) que pode levar à escalada de privilégios locais sem privilégios de execução adicionais, embora a interação do usuário seja necessária para exploração; CVE-2024-20106 (afetando os chipsets MT6739, MT6761, MT6765, entre outros) que também pode resultar em aumento de privilégios locais, mas requer privilégios de execução do sistema e nenhuma interação do usuário.
<br> Ação: Atualizar o Android para a versão mais recente conforme disponibilizado pelo fabricante do aparelho, não baixar aplicativos de fontes desconhecidas e não clicar em atalhos de mensagens não solicitadas.
<br> Publicado [aqui](https://cybersecuritynews.com/mediatek-smartphone-chipsets-vulnerabilities/)

<br> **2024.11.04 [SEC:HIGH] Opera Browser 0-Day Flaw**
<br> Foi descoberta uma vulnerabilidade crítica no navegador Opera que pode permitir que extensões maliciosas obtenham acesso não autorizado a APIs privadas, o que pode levar ao sequestro de contas e outras violações graves de segurança.
...
<br> **2024.10.29 [SEC:HIGH] Downgrade de segurança do Remote Desktop (RDP) para acesso não autorizado**
<br> O ataque é feito através phishing com atalhos anexados a e-mails que são executados no PowerShell do Windows, onde scripts realizam uma série de atividades para criar uma conta com privilégio administrativo e então permitir a conexão remota sem detecção.
...
<br> A new encoding technique has been discovered that can jailbreak OpenAI's ChatGPT-4, allowing users to bypass safety measures and generate harmful or restricted content. This vulnerability raises concerns over the misuse of AI systems. 
...
<br> Vulnerabilidade no sistema de autenticação da EA permitiu a manipulação de contas de usuários através da exploração de documentação de API exposta e um único endpoint inseguro.
<br> Publicado [aqui](https://battleda.sh/blog/ea-account-takeover)


<br> **2024.10.17 [SEC:HIGH] Grafana lança correção urgente para falha de segurança crítica**
<br> Uma falha crítica no Grafana, ferramenta amplamente utilizada para monitoramento de sistemas e análise de dados, colocou inúmeras organizações em risco. A vulnerabilidade permite que atacantes com permissões de “visualizador” ou superiores executem injeções de comandos e obtenham acesso a arquivos locais sensíveis.
